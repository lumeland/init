...
## [0.7.0] - 2026-06-17
### Added
- Allow to install any theme using the manifest URL. For example:
  ```
  lume init --theme="https://example.com/manifest.json"
  ```

### Changed
- Don't update the themes automatically.

## [0.6.1] - 2026-06-05
### Added
- New task `new` to run artifacts. For example `deno task new post "hello world"`.

## [0.6.0] - 2026-05-27
### Added
- `npm:@parcel/watcher` to the list of denied scripts (it's an optional dependency of SASS).

### Changed
- Themes: The specifier name for all themes is "theme".
- Themes: Support for custom permissions.

## [0.5.8] - 2026-05-25
### Changed
- Set minimum Deno version supported to 2.7.x.

## [0.5.7] - 2026-03-20
### Added
- `allowScripts` configuration to deny the script of `npm:sharp`.

### Removed
- `temporal` from the list of unstable APIs, since it's enabled by default in Deno 2.7.

## [0.5.6] - 2025-11-29
### Fixed
- Added `deno.land:443` and `esm.sh:443` to the list of net permissions because they are required by GitHub actions.

## [0.5.5] - 2025-10-18
### Fixed
- Fetch themes from JsDelivr to avoid extra permissions configuration.

## [0.5.4] - 2025-10-18
### Fixed
- Added `esm.sh:443` to the list of import permissions.
...
[0.6.1]: https://github.com/lumeland/init/compare/v0.6.0...v0.6.1
[0.6.0]: https://github.com/lumeland/init/compare/v0.5.8...v0.6.0
[0.5.8]: https://github.com/lumeland/init/compare/v0.5.7...v0.5.8
[0.5.7]: https://github.com/lumeland/init/compare/v0.5.6...v0.5.7
[0.5.6]: https://github.com/lumeland/init/compare/v0.5.5...v0.5.6
[0.5.5]: https://github.com/lumeland/init/compare/v0.5.4...v0.5.5
[0.5.4]: https://github.com/lumeland/init/compare/v0.5.3...v0.5.4
